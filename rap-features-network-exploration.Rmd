...
parens <- c("\\($",")$")
parens_match <- str_c(parens, collapse = "|")
```
...
all_tracks$artist <- trimws(all_tracks$artist)
all_tracks$track_name <- trimws(all_tracks$track_name)
...
all_tracks_w_feats$feature_list <- gsub("^ ","",all_tracks_w_feats$feature_list)
all_tracks_w_feats$feature_list <- gsub(" $","",all_tracks_w_feats$feature_list)
all_tracks_w_feats$feature_list <- gsub(" $","",all_tracks_w_feats$feature_list)
all_tracks_w_feats$feature_list <- gsub("-","",all_tracks_w_feats$feature_list)
all_tracks_w_feats$feature_list <- gsub("^uring","",all_tracks_w_feats$feature_list)
...
```{r De-duplicate the edge list and node list}
