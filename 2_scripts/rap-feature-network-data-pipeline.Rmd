...
# In progress
### Extended Track Data
```{r Split extended albums dataframe into smaller chunks for manageable queries}
albums_df_extended <- read_csv("../1_data/Spotify/albums_extended.csv") 

albums_df_extended <- albums_df_extended %>%
  mutate(index_to_split = as.numeric(row.names(albums_df_extended)),
...
```{r 1 of 10: Extended Spotify album tracks}
...
```{r 2 of 10: Extended Spotify album tracks}
...
```{r 3 of 10: Extended Spotify album tracks}
