...
albums_df_2 <- read_csv("../1_data/Spotify/albums_extended.csv")
split(x = albums_df_2, f = rep(1:ceiling(nrow(albums_df_2)/1000)))
```


```{r Get extended Spotify album tracks}
tracks_df_2 <- query_tracks_flat(albums_df_2$album_uri, albums_df_2$album_name)
