...
```{r Get extended Spotify artist data}
...
write_csv(artists_df_combined, "../1_data/Spotify/artists.csv")
```

```{r Get extended Spotify album IDs}
# Get Spotify album identifiers for all these artists
...
write_csv(albums_df_combined, "../1_data/Spotify/albums.csv")
```
