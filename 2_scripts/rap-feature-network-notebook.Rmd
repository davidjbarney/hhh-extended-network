...
write_csv(artists_df, "../1_data/all_artists.csv")
```
...
write_csv(albums_df, "../1_data/all_albums.csv")
```

```{r Get tracks, eval=FALSE}
albums_df <- read_csv("../1_data/all_albums.csv")
...
write_csv(all_tracklists, "../1_data/all_tracklists.csv")
```

```{r Get track data from tracklists, eval=FALSE}
all_tracklists <- read_csv("../1_data/all_tracklists.csv")
...
artists_df <- read_csv("../1_data/all_artists.csv")
albums_df <- read_csv("../1_data/all_albums.csv")
